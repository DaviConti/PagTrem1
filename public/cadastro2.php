...
<body>
  <div class="container">
    ...
    <form id="cadastroForm" method="POST" action="">
      ...
      <input type="text" id="nome" name="nome" placeholder="Digite aqui..." value="<?= htmlspecialchars($nome) ?>" required>

      <label for="nascimento">Data de nascimento:</label>
      <input type="text" id="nascimento" name="nascimento" placeholder="dd / mm / aaaa" value="<?= htmlspecialchars($nascimento) ?>" required>
